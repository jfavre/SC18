...
indeed, and we are not able to load a half-size domain on a single node equipped
...
and we report the delivery of the first image in 2.1, 4.0, and 8.0 seconds, respectively. the associated cost in RAM is also linear, at 27.6Gb, 55.1Gb and 110 Gb, respesctively.
